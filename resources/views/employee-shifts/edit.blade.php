        ...
        <x-form id="createTicket" method="PUT" class="ajax-form">
            <div class="form-group">
              ...
              <div class="col-lg-12 mb-2">
                        <x-forms.checkbox :fieldLabel="__('modules.attendance.outsideClockIn')" fieldName="allow_outside_clockin"
                            fieldId="allow_outside_clockin" fieldValue="yes" :checked="$employeeShift->allow_outside_clockin == 'yes'" />
                    </div>
                    <div class="col-lg-4">
