            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                     ...
                     <div class="col-lg-12">
                        <x-forms.checkbox  class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.attendance.outsideClockIn')" fieldName="allow_outside_clockin"
                            fieldId="allow_outside_clockin"  />
                    </div>
