<div class="row">
    <div class="col-sm-12">
        <x-form id="save-holiday-data-form" >
            <div class="add-client bg-white rounded">
                ...
                <div class="row pl-20 pr-20 pt-20">
                    ...
                    <div class="col-lg-4">
                        <x-forms.select fieldId="holiday_type" :fieldLabel="__('modules.holiday.type')" fieldName="holiday_type[]" fieldRequired="true">
                    ...
                    <div class="col-lg-3">
                        <x-forms.file allowedFileExtensions="png jpg jpeg svg bmp" class="mr-0 mr-lg-2 mr-md-2 cropper"
                            :fieldLabel="__('modules.profile.profilePicture')" fieldName="image[]" fieldId="image1"
    ...
    $(document).ready(function() {
        ...
        $('#add-item').click(function() {
            ...
            $(`<div id="addMoreBox${i}" class="row pl-20 pr-20 clearfix">
                <div class="col-lg-3 col-md-3 col-12"> <x-forms.text class="date-picker" :fieldLabel="__('app.date')" fieldName="date[]"
                fieldId="dateField${i}" :fieldPlaceholder="__('app.date')" fieldValue="{{ $date }}" fieldRequired="true"  />
                </div>  <div class="col-lg-3 col-md-3 col-10"> <div class="form-group my-3">
                <x-forms.text :fieldLabel="__('modules.holiday.occasion')" fieldName="occassion[]" fieldId="occassion${i}" :fieldPlaceholder="__('modules.holiday.occasion')" fieldValue="" fieldRequired="true" />
                        ...
                        <x-forms.select fieldId="holiday_type${i}" :fieldLabel="__('modules.holiday.type')" fieldName="holiday_type[]" fieldRequired="true"> 
                            <option value="Restricted">Restricted</option>
                            <option value="Gazetted">Gazetted</option>
                        </x-forms.select>
                    ...
                    <div class="col-lg-3">
                        <x-forms.file allowedFileExtensions="png jpg jpeg svg bmp" class="mr-0 mr-lg-2 mr-md-2 cropper"
                            :fieldLabel="__('modules.profile.profilePicture')" fieldName="image[]" fieldId="image${i}"
                            fieldHeight="119" :popover="__('messages.fileFormat.ImageFile')" />
                    </div>
                    <div class="col-lg-2 col-md-1 col-2"><a href="javascript:;" class="d-flex align-items-center justify-content-center mt-5 remove-item" data-item-id="${i}"><i class="fa fa-times-circle f-20 text-lightest"></i></a></div></div> `)
...
console.log($('#save-holiday-data-form').serialize());
