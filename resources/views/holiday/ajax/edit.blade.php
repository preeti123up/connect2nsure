                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-4">
                        <x-forms.select fieldId="holiday_type" :fieldLabel="__('modules.holiday.type')" fieldName="holiday_type" fieldRequired="true">
                            <option @if ($holiday->holiday_type=='Restricted') selected @endif  value="Restricted">Restricted</option>
                            <option @if ($holiday->holiday_type=='Gazetted') selected @endif  value="Gazetted">Gazetted</option>
                        </x-forms.select>
                    </div>
                    <div class="col-lg-3">
                        <x-forms.file allowedFileExtensions="png jpg jpeg svg bmp" class="mr-0 mr-lg-2 mr-md-2 cropper"
                            :fieldLabel="__('modules.profile.profilePicture')"
                            :fieldValue="($holiday->app_banner ? $holiday->banner_url : $holiday->banner_url)" fieldName="image"
