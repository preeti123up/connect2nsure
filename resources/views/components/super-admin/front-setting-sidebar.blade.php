...
<div class="settings-sidebar bg-white py-3" id="mob-settings-sidebar">
    ...
    <ul class="settings-menu" id="settingsMenu">
        ...
        <x-setting-menu-item :active="$activeMenu" menu="social_link"
           ...
           <x-setting-menu-item :active="$activeMenu" menu="social_link"
                            :href="route('superadmin.front-settings.fetature.readMore-details')"
                            :text="__('Module Details')">
        </x-setting-menu-item>
                <x-setting-menu-item :active="$activeMenu" menu="social_link"
                            :href="route('superadmin.front-settings.blog.readMore-details')"
                            :text="__('Blog')">
        </x-setting-menu-item>
        <x-setting-menu-item :active="$activeMenu" menu="social_link"
                            :href="route('superadmin.front-settings.enquiry.readMore-details')"
                            :text="__('Enquiry List')">
        </x-setting-menu-item>
           <x-setting-menu-item :active="$activeMenu" menu="social_link"
                            :href="route('superadmin.front-settings.onboard-screen.readMore-details')"
                            :text="__('OnBoardScreen')">
        </x-setting-menu-item>
    </ul>
    <!-- SETTINGS MENU END -->
