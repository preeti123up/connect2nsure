                    ...
                    <div class="col-md-4 col-lg-3">
                        <x-forms.select fieldId="country" :fieldLabel="__('app.country')" fieldName="country"
                            ...
                            @foreach ($countries as $item)
                                 @if ($employee->country_id == $item->id)
                    ...
                    <div class="col-md-4">
                        ...
                        <x-forms.input-group style="margin-top:-4px">
                            <x-forms.select fieldId="country_phonecode" fieldName="country_phonecode"
                                search="true">
                                @foreach ($countries as $item)
                                      @if($employee->country_phonecode == $item->phonecode)
                    ...
                    <div class="col-md-4 col-lg-3">
                        <x-forms.select fieldId="assign_branch" :fieldLabel="__('Assign Branch')" fieldName="assign_branch[]" multiple>
                            @foreach ($branches as $branch)
                                <option value="{{ $branch->id }}" @if(!empty($getBranchIds) && in_array($branch->id, $getBranchIds)) selected @endif>{{ $branch->branch_name }}</option>
                            @endforeach
                        </x-forms.select>
                    </div>
                  @endif
                    ...
                    <div class="form-group my-3">
                            ...
                            <div class="d-flex">
                                <x-forms.radio fieldId="ood-yes" :fieldLabel="__('app.enable')" fieldName="ood"
                                    fieldValue="enable" :checked="($employee->ood == 'enable') ? 'checked' : ''">
                                </x-forms.radio>
                                <x-forms.radio fieldId="ood-no" :fieldLabel="__('app.disable')"  fieldValue="disable" 
                                    fieldName="ood" :checked="($employee->ood == 'disable') ? 'checked' : ''"></x-forms.radio>
                            </div>
                        </div>
                    </div>
                ...
                <x-forms.label class="my-3" fieldId="BankName"
                        ...
                        <x-forms.input-group>
                            <select class="form-control select-picker" name="bank_name" id="bank_name"
                                ...
                                @foreach($bankNames as $n)
                                 <option value="{{$n->name}}" @if($employee->employeeDetail->bank_name==="$n->name") selected @endif >{{$n->name}}</option>
                                @endforeach
                            </select>
                                <x-slot name="append">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <x-forms.text fieldId="account_no" :fieldLabel="__('Account Number')"
                            fieldName="account_no" :fieldValue="$employee->employeeDetail->account_no" >
                        </x-forms.text>
                    </div>
                    <div class="col-lg-4 col-md-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                                <x-forms.text fieldId="UAN_no" :fieldLabel="__('UAN No. ')"
                                    fieldName="UAN_no" :fieldValue="$employee->employeeDetail->UAN_no" >
                                </x-forms.text>
                            </div>
                    <div class="col-lg-4 col-md-6">
                        <x-forms.text fieldId="PF_no" :fieldLabel="__('PF No. ')"
                            fieldName="PF_no" :fieldValue="$employee->employeeDetail->PF_no">
                        </x-forms.text>
                    </div>
