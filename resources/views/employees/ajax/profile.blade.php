                    ...
                    <div class="col-xl-7 col-md-6 mb-4 mb-lg-0">
                        ...
                        <x-cards.data :title="__('modules.client.profileInfo')" class=" mt-4">
                            ...
                            @endif
                                ...
                                :value="(!is_null($employee->employeeDetail) && !is_null($employee->employeeDetail->bank_name)) ? $employee->employeeDetail->bank_name : '--'" />

                                <x-cards.data-row :label="__('Account Number')"
                                :value="(!is_null($employee->employeeDetail) && !is_null($employee->employeeDetail->account_no)) ? $employee->employeeDetail->account_no : '--'" />

                                <x-cards.data-row :label="__('IFSC Code')"
                                :value="(!is_null($employee->employeeDetail) && !is_null($employee->employeeDetail->ifsc_code)) ? $employee->employeeDetail->ifsc_code : '--'" />
                               
                                <x-cards.data-row :label="__('UAN Number')"
                                :value="(!is_null($employee->employeeDetail) && !is_null($employee->employeeDetail->UAN_no)) ? $employee->employeeDetail->UAN_no : '--'" />
                                
                                <x-cards.data-row :label="__('PF Number')"
                                :value="(!is_null($employee->employeeDetail) && !is_null($employee->employeeDetail->PF_no)) ? $employee->employeeDetail->PF_no : '--'" />
