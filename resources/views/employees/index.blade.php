    ...
    <x-filters.filter-box>
       ...
       <!--Branch start-->
        <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
            ...
            <div class="select-status">
                <select class="form-control select-picker" name="branch" id="branch">
                    <option value="all">@lang('app.all')</option>
        ...
        <div class="d-flex justify-content-between action-bar">
            ...
            <div id="table-actions" class="d-block d-lg-flex align-items-center">
                ...
                @endif
                 ...
                 @if ($addEmployeePermission == 'all')
                    <x-forms.link-secondary :link="route('employees.download.excel.formate')" class="mr-3  mb-2 mb-lg-0 d-none d-lg-block"
                                            icon="file-download">
                    Download Format
                    </x-forms.link-secondary>
                 @endif
...
@push('scripts')
    ...
    <script>
        ...
        $('#employees-table').on('preXhr.dt', function (e, settings, data) {
            ...
            if (status == "all" || employee == "all" || role == "all" || designation == "all" || searchText == ""||branch=="all") {
        ...
        $('#employee, #status, #role, #gender, #skill, #designation, #department,#branch').on('change keyup',
            function () {
                if ($('#status').val() != "all") {
