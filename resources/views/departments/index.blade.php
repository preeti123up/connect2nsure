        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                @if ($addDepartmentPermission == 'all')
                   ...
                   <x-forms.link-secondary :link="route('departments.import')" class="mr-3 openRightModal float-left"
                    icon="file-upload">
                    @lang('app.importExcel')
                   </x-forms.link-secondary>
                   <x-forms.link-secondary :link="route('departments.download.excel.formate')" class="mr-3  float-left"
                                    icon="file-download">
                        Download
                   </x-forms.link-secondary>
                @endif
