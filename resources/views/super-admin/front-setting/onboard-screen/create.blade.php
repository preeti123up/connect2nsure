...
<div class="modal-header">
    <h5 class="modal-title">@lang('Add OnBoard Screen')</h5>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            <x-forms.file allowedFileExtensions="png jpg jpeg svg webp" class="mr-lg-2 mr-md-2 mr-0" mutliple
...
<script>
    ...
    $('#save-feature').click(function(event) {
        ...
        $.easyAjax({
            url: "{{ route('superadmin.front-settings.onboard-screen.store') }}",
