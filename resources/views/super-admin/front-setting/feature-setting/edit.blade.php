            ...
            <div class="form-group">
                <div class="row">
                    ...
                    @if ((isset($type) && $type == 'image') || $type == 'apps')
                        <div class="col-md-12">
                            <x-forms.file allowedFileExtensions="png jpg jpeg svg avif gif" class="mr-lg-2 mr-md-2 mr-0"
                       ...
                       <label for="feature_title2">Title-1</label>
                        <input type="text" class="form-control" name="feature_title1" value="{{$featureImage->feature_title1??null}}" >
                       </div>
                        <div class="col-md-12 mt-3">
                        <label for="feature_title2">Description-1</label>
                        <textarea  name="feature_description1" class="form-control"  required >{{$featureImage->feature_description1??null}}</textarea>
                       </div>

                        <div class="col-md-12 ">
                            <?php $image=asset('user-uploads/front/feature/'.$featureImage['feature_icon1'])?>
                        <x-forms.file allowedFileExtensions="png jpg jpeg svg" class="mr-lg-2 mr-md-2 mr-0"
                                :fieldValue="$image??null"
                                :fieldLabel="__('Icon-1')" fieldName="feature_icon1" fieldId="feature_icon1" >
                            </x-forms.file>
                        <!-- <input type="file" class="form-control" name="feature_icon1" accept="png"> -->
                       ...
                       <div class="col-md-12 mt-3">
                        <label for="feature_title2">Title-2</label>
                        <input type="text" class="form-control" name="feature_title2" value="{{$featureImage->feature_title2??null}}" >
                       </div>

                       <div class="col-md-12 mt-3">
                    <label for="feature_title2">Description-2</label>
                        <textarea  class="form-control" name="feature_description2" row="6" required>{{$featureImage->feature_description2??null}}</textarea>
                    </div>


                       <div class="col-md-12">
                         <?php $image2=asset('user-uploads/front/feature/'.$featureImage['feature_icon2'])?>

                       <x-forms.file allowedFileExtensions="png jpg jpeg svg" class="mr-lg-2 mr-md-2 mr-0"
                                :fieldValue="$image2??null"
                                :fieldLabel="__('Icon-2')" fieldName="feature_icon2" fieldId="feature_icon2" >
                            </x-forms.file>
                        <!-- <input type="file" class="form-control" name="feature_icon2" required> -->
                      </div>
