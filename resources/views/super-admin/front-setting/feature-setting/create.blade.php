                ...
                <div class="row">
                    ...
                    @if ((isset($type) && $type == 'image') || $type == 'apps')
                       ...
                       <label for="feature_title2">Title-1</label>
                        <input type="text" class="form-control" name="feature_title1" >
                       </div>
                        <div class="col-md-12 mt-3">
                        <label for="feature_title2">Description-1</label>
                        <textarea  name="feature_description1" class="form-control"  required ></textarea>
                       </div>
                       ...
                       <div class="col-md-12 mt-3">
                        ...
                        <input type="text" class="form-control" name="feature_title2"  >
                       </div>

                       <div class="col-md-12 mt-3">
                    <label for="feature_title2">Description-2</label>
                        <textarea  class="form-control" name="feature_description2" row="6" required></textarea>
                    </div>
