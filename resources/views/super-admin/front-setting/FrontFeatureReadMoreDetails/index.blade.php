        ...
        <x-slot name="buttons">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-2">
                        <x-forms.button-primary icon="plus" class="image-btn mb-2 addFeature" data-type="image">
                            @lang('Add')
...
$('body').on('click', '.addFeature', function () {
        ...
        var url = "{{ route('superadmin.front-settings.FrontFeatureReadMoreDetails.create') }}?featureSettingId="+featureSettingId + "&type="+type;
    ...
    $('body').on('click', '.edit-feature', function () {
        var id = $(this).data('id');
        var type = $(this).data('type');
        var url = "{{ route('superadmin.front-settings.FrontFeatureReadMoreDetails.edit', ':id')}}?type="+type;
    ...
    $('body').on('click', '.read-more-table-row', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "{{ route('superadmin.front-settings.FrontFeatureReadMoreDetails.delete', ':id') }}";
                url = url.replace(':id', id);
