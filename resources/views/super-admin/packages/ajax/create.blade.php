                        ...
                        <div class="monthly_package row">
                            ...
                            <div class="col-md-12">
                                <x-forms.number class="currency_symbol"
                                    ...
                                    fieldName="monthly_versional_price" fieldRequired="false" fieldId="monthly_versional_price"/>
                            </div>
                            ...
                            <div class="col-md-12">
                              ...
                              <div class="col-md-12">
                                <x-forms.number class="currency_symbol"
                                    ...
                                    fieldName="annual_versional_price" fieldRequired="false" fieldId="annual_versional_price"/>
                            </div>
                            @if($paymentGateway->stripe_status == 'active')
                                <div class="col-md-12">
