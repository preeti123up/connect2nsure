                        ...
                        <div class="col-md-6">
                            <div class="row monthly_package @if (!$package->monthly_status) d-none @endif">
                                ...
                                <x-forms.number class="currency_symbol"
                                    :fieldLabel="__('Monthly Versional Price')"
                                    fieldName="monthly_versional_price" fieldRequired="false" fieldId="monthly_versional_price" :fieldValue="$package->monthly_versional_price"/>
                                 </div>
                        ...
                        <div class="col-md-6">
                            <div class="row annual_package @if (!$package->annual_status) d-none @endif">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                <x-forms.number class="currency_symbol"
                                    :fieldLabel="__('Annual Versional Price')"
                                    fieldName="annual_versional_price" fieldRequired="true" fieldId="annual_versional_price" :fieldValue="$package->annual_versional_price"/>
                               </div>
                                @if($paymentGateway->stripe_status == 'active')
                                    <div class="col-md-12">
