            ...
            <div class="tab-content" id="tab-content">
                ...
                <div class="tab-pane active" id="personal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <x-forms.number :fieldLabel="__('modules.leaves.maxLimit')"
                                fieldName="max_limit" fieldId="max_limit" :fieldValue="$leaveType->max_limit"
                                fieldRequired="true" :fieldHelp="__('modules.leaves.maxLimitInfo')" minValue="0" :popover="__('messages.leave.max_limit')"/>
                        </div>
                        <div class="col-lg-4">
                ...
                <div class="tab-pane" id="promotion">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <div class="d-flex mt-3">
                                    <x-forms.checkbox :fieldLabel="__('modules.leaves.adjustSendwich')"
                                            fieldName="adjust_sandwich" fieldId="adjust_sandwich" fieldValue="1" fieldRequired="true" :checked="$leaveType->adjust_sandwich == 1"
                                            :popover="__('messages.leave.adjustSendwich')"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
