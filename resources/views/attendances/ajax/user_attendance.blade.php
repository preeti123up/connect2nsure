@forelse ($dateWiseData as $key => $dateData)
    ...
    @endphp
@if (isset($dateData['attendance']) && ($dateData['attendance'] == true) && ($dateData['leave'] != true || $dateData['leave']['duration']=='half_day')))
        ...
        <tr>
            ...
            <td>
                @if(!(isset($dateData['leave']['duration']) && $dateData['leave']['duration'] == 'half_day'))
    ...
    @else
        <tr>
            ...
            <td>
                 @if($dateData['holiday']=='Week Off')
                <label class="badge badge-secondary">Week Off</label>
                ...
                @elseif($dateData['leave'])
                    @if ($dateData['leave']['duration'] == 'half_day')
                        <label class="badge badge-primary">@lang('modules.attendance.leave')</label><br><br>
                        <label class="badge badge-warning">@lang('modules.attendance.halfDay')</label>
                    @else
