    ...
    <script>
        ...
        @if (canDataTableExport())
             ...
             var url =
                ...
                url = url.replace(':date', date).replace(':year', year).replace(':month', month).replace(':userId', userId).replace(':department', department).replace(':designation', designation).replace(':branch',branch);
