...
<table class="logo">
    <tr>
        ...
        <td><p style="text-align: right;">
                <img src="{{ asset('user-uploads/app-logo/'.$company->logo)}}" id="logo">
            </p>

            <p style="text-align: right;">

                <b>{{ $company->company_name ?? $salarySlip->user->employeeDetail->company->company_name }}</b><br/>
                {!! nl2br($company->defaultAddress->address ?? $salarySlip->user->employeeDetail->company->address) !!}<br/>
                <b>@lang('app.phone')</b>: {{ $company->company_phone ?? $salarySlip->user->employeeDetail->company->company_phone }}<br/>
                <b>@lang('app.email')</b>: {{$company->company_email ?? $salarySlip->user->employeeDetail->company->company_email}}
