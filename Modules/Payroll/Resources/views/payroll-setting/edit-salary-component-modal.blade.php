        ...
        <x-form id="editSalaryComponents" method="PUT" class="ajax-form">
            <div class="form-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <x-forms.number fieldId="max_value" :fieldLabel="__('payroll::modules.payroll.componentValueMax')" fieldValue="{{$salaryComponent->max_value}}"
                                      fieldName="max_value" fieldRequired="false">
                        </x-forms.number>
                    </div>
