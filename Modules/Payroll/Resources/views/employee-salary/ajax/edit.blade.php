                                    ...
                                    <div class="col-md-12 mt-1">
                                        <div class="row">
                                            @if ($value->component->component_type == 'earning')
                                                <div class="col-md-3">
                                                    <x-forms.label fieldId="" :fieldLabel="ucfirst($value->component->component_name)" />
                                                </div>
                                                <div class="col-md-3">
                                                    ...
                                                    @else
                                                        <x-forms.label fieldId="" :fieldLabel="ucfirst($value->component->value_type) ?? '--'" />
                                                    @endif
                                                </div>
                                                <div class="col-md-3">
                                            ...
                                            <div class="row">
                                                @if ($value->component->component_type == 'deduction')
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        @elseif($value->component->value_type == 'basic_percent')
                                                       @php
    $componentValue = $payrollController->currencyFormatterCustom(($basicSalary / 100) * $value->component->component_value);
    if ($value->component->value_type !== 0 && $componentValue > $value->component->max_value) {
        $componentValue = $value->component->max_value;
    }
@endphp
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        @elseif($value->component->value_type == 'basic_percent')
                                                                                                               @php
    $componentValue = ($basicSalary / 100) * $value->component->component_value;
    if ($value->component->value_type !== 0 && $componentValue > $value->component->max_value) {
        $componentValue = $value->component->max_value;
    }
@endphp
