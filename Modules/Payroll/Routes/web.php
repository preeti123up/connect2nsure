...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::prefix('payroll')->group(function () {
        ...
        Route::get('payroll/export/{start_date}/{end_date}', [PayrollController::class, 'exportPayroll'])->name('payroll.export');
        Route::get('payroll/export-details/{start_date}/{end_date}', [PayrollController::class, 'exportPayrollDetails'])->name('payroll.export-details');
