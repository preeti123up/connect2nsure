        ...
        if (!is_null($this->salaryGroup)) {
            ...
            foreach ($this->salaryGroup->salary_group->components as $component) {
                ...
                if ($component->component->component_type == 'earning') {
                    ...
                    if ($component->component->value_type == 'basic_percent') {
                          $componentValue = $this->basicSalary / 100 * $component->component->component_value;
                       if($component->component->max_value !== 0 && $componentValue > $component->component->max_value){
                     $totalExpenses[] = $component->component->max_value;
                      }else{
                       $totalExpenses[] = $componentValue;  
                       }
                    }
