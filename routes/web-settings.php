...
use App\Http\Controllers\BranchAssignController;
...
Route::group(['middleware' => 'auth', 'prefix' => 'account/settings'], function () {
    ...
    Route::get('branch-master-edit/{id}',[BranchController::class,'edit'])->name('branch-master.edit');
    Route::post('branch-master-update/{id}',[BranchController::class,'update'])->name('branch-master.update');
    Route::delete('branch-destroy/{id}',[BranchController::class,'destroy'])->name('branch.destroy');
    
      //Asssign branch Controller
    Route::get('assign-branch',[BranchAssignController::class,'index'])->name('assign-branch.index');
    Route::get('assign-branch-create',[BranchAssignController::class,'create'])->name('assign-branch.create');
    Route::post('assign-branch-store',[BranchAssignController::class,'store'])->name('assign-branch.store');
    Route::get('assign-branch-master-list/{id}',[BranchAssignController::class,'list'])->name('assign-branch-master.list');
    Route::delete('assign-branch-destroy/{id}',[BranchAssignController::class,'destroy'])->name('assign-branch.destroy');
    
     // Wishes Setting

    Route::get('wishes-setting',[WishesController::class,'index'])->name('wishes.index');
    Route::get('wishes-setting/create',[WishesController::class,'create'])->name('wishes.create');
    Route::post('wishes-setting/store',[WishesController::class,'store'])->name('wishes.store');
    Route::get('wishes-setting/edit/{id}',[WishesController::class,'edit'])->name('wishes.edit');
    Route::delete('wishes-setting/destroy/{id}',[WishesController::class,'destroy'])->name('wishes.destroy');
    Route::post('wishes-setting/update/{id}',[WishesController::class,'update'])->name('wishes.update');
      ...
      //Diveces
       ...
       Route::delete('devices/destroy/{id}',[DevicesController::class,'destroy'])->name('devices.destroy');

  Route::get('bank-name',[BankNameMasterController::class,'index'])->name('bank-name.index');
      Route::get('bank-name',[BankNameMasterController::class,'index'])->name('bank-name.index');
      Route::get('bank-name/create',[BankNameMasterController::class,'create'])->name('bank-name.create');
      Route::post('bank-name/store',[BankNameMasterController::class,'store'])->name('bank-name.store');
      Route::get('bank-name/edit/{id}',[BankNameMasterController::class,'edit'])->name('bank-name.edit');
      Route::post('bank-name/update/{id}',[BankNameMasterController::class,'update'])->name('bank-name.update');
      Route::delete('bank-name/destroy/{id}',[BankNameMasterController::class,'destroy'])->name('bank-name.destroy');
