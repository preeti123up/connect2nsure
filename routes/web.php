...
Route::group(['middleware' => ['auth', 'multi-company-select', 'email_verified'], 'prefix' => 'account'], function () {
    ...
    Route::get('employees/sendEmail/{id}', [EmployeeController::class, 'sendEmail'])->name('employees.sendEmail');
    ...
    Route::post('employees/import/process', [EmployeeController::class, 'importProcess'])->name('employees.import.process');
     Route::get('employees/download-excel-formate',[EmployeeController::class, 'exportFormate'])->name('employees.download.excel.formate');
    ...
    Route::get('designations/download-excel-formate',[DesignationController::class, 'exportFormate'])->name('designations.download.excel.formate');
    Route::get('designations/import',[DesignationController::class, 'importMember'])->name('designations.import');
    Route::post('designations/import', [DesignationController::class, 'importStore'])->name('designations.import.store');
    Route::post('designations/import-process', [DesignationController::class, 'importProcess'])->name('designations.import.process');
    ...
    Route::get('department-download-excel-formate',[DepartmentController::class, 'exportFormate'])->name('departments.download.excel.formate');
    Route::get('department-import',[DepartmentController::class, 'importMember'])->name('departments.import');
    Route::post('departments-import-process', [DepartmentController::class, 'importProcess'])->name('departments.import.process');
    Route::post('department-import', [DepartmentController::class, 'importStore'])->name('departments.import.store');
    ...
    Route::get('leaves/pending-leaves', [LeaveController::class, 'pendingLeaves'])->name('leaves.pending');
    ...
    Route::get('attendances/export-all-attendance/{date}/{year}/{month}/{id}/{department}/{designation}/{branch}', [AttendanceController::class, 'exportAllAttendance'])->name('attendances.export_all_attendance');
    ...
    Route::get('attendances/list/{id}', [AttendanceController::class, 'list'])->name('attendances.list');
    Route::post('attendances/approve-or-reject/{id}', [AttendanceController::class, 'approveOrRejectAttendance'])->name('attendances.approve-or-reject');
    ...
    Route::get('attendance/{id}/{day}/{month}/{year}', [AttendanceController::class, 'addAttendance'])->name('attendances.add-user-attendance');
      Route::get('pendingAttendance', [AttendanceController::class, 'pendingAttendance'])->name('pendingAttendance.index');
    Route::get('pendingAttendance/{id}', [AttendanceController::class, 'list'])->name('pendingAttendance');
    ...
    Route::get('reimbursement/{id}/{uniqueId}', [ReimbursementController::class,'list'])->name('reimbursement.list');
    Route::post('reimbursement/{id}', [ReimbursementController::class,'changeStatus'])->name('reimbursement.approved');
    Route::post('reimbursement/status/{id}', [ReimbursementController::class,'changeStatus'])->name('reimbursement.status');
    
   //asset
    Route::get('asset/list/{id}', [AssetController::class,'list'])->name('asset.list');
    Route::post('asset/status/{id}', [AssetController::class,'status'])->name('asset.status');
    Route::get('asset/lend-asset/{id}', [AssetController::class,'lendAsset'])->name('lend.asset');
    Route::get('asset/return-lended-asset/{id}', [AssetController::class,'returnLendedAsset'])->name('return.lended.asset');
    Route::post('asset/store-return-asset', [AssetController::class,'storeReturnedAsset'])->name('store.return.asset');
    Route::post('asset/store-lend', [AssetController::class,'storeLendAsset'])->name('asset.storeLend');
    Route::post('asset/status/{id}', [AssetController::class,'changeStatus'])->name('asset.status');
    Route::resource('asset', AssetController::class);

    //interview application
    Route::resource('interview', InterviewApplicationController::class);
    route::post('assign/{id}',[InterviewApplicationController::class,'assignInterview'])->name('assign.assignInterview');
    route::post('status/{id}',[InterviewApplicationController::class,'statusUpdate'])->name('status.statusUpdate');
    route::get('remarks/{id}',[InterviewApplicationController::class,'remarks'])->name('interview.remarks');  

    //end interview appliction
