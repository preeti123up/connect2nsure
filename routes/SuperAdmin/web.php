...
use App\Http\Controllers\SuperAdmin\FrontSetting\FrontReadMoreFeatureDetailController;
use App\Http\Controllers\SuperAdmin\FrontSetting\BlogController;
use App\Http\Controllers\SuperAdmin\FrontSetting\EnquiryController;
use App\Http\Controllers\SuperAdmin\FrontSetting\OnboardScreenController;
...
Route::group(['middleware' => ['auth', 'super-admin'], 'prefix' => 'account', 'as' => 'superadmin.'], function () {
  ...
  //Front Read More Feature Details
        Route::get('/front-read-more-detail',[FrontReadMoreFeatureDetailController::class,'index'])->name('fetature.readMore-details');
        Route::get('/front-read-more-detail/create',[FrontReadMoreFeatureDetailController::class,'create'])->name('FrontFeatureReadMoreDetails.create');
        Route::post('/front-read-more-detail/post',[FrontReadMoreFeatureDetailController::class,'store'])->name('FrontFeatureReadMoreDetails.store');
        Route::get('/front-read-more-detail/{id}',[FrontReadMoreFeatureDetailController::class,'edit'])->name('FrontFeatureReadMoreDetails.edit');
        Route::put('/front-read-more-detail/{id}',[FrontReadMoreFeatureDetailController::class,'update'])->name('FrontFeatureReadMoreDetails.update');
        Route::delete('/front-read-more-detail/{id}',[FrontReadMoreFeatureDetailController::class,'deleteDataReadMore'])->name('FrontFeatureReadMoreDetails.delete');
        
         Route::get('/blog',[BlogController::class,'index'])->name('blog.readMore-details');
         ...
         Route::delete('/blog/{id}',[BlogController::class,'deleteDataReadMore'])->name('blog.delete');
         
            //onborad screen
         Route::get('/onboard-screen',[OnboardScreenController::class,'index'])->name('onboard-screen.readMore-details');
         Route::get('/onboard-screen/create',[OnboardScreenController::class,'create'])->name('onboard-screen.create');
         Route::post('/onboard-screen/post',[OnboardScreenController::class,'store'])->name('onboard-screen.store');
         Route::get('/onboard-screen/{id}',[OnboardScreenController::class,'edit'])->name('onboard-screen.edit');
         Route::put('/onboard-screen/{id}',[OnboardScreenController::class,'update'])->name('onboard-screen.update');
         Route::delete('/onboard-screen/{id}',[OnboardScreenController::class,'deleteDataReadMore'])->name('onboard-screen.delete');
         
 
         Route::get('/enquiry',[EnquiryController::class,'index'])->name('enquiry.readMore-details');
