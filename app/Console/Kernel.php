...
use App\Console\Commands\SendWorkAnniversary;
...
use App\Console\Commands\SendLeaveReminder;
...
use App\Console\Commands\SuperAdmin\LicenceExpire;
use App\Console\Commands\SendMarriageAnniversaryWishes;
...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        TrialExpire::class,
         LicenceExpire::class,
        SendMarriageAnniversaryWishes::class,
        SendLeaveReminder::class,
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        // $schedule->command('birthday-notification')->dailyAt('1:00')->timezone($timezone);
        $schedule->command('birthday-wishes')->dailyAt('6:00')->timezone($timezone);
        $schedule->command('send-work-anniversary')->dailyAt('6:00')->timezone($timezone);
        $schedule->command('send-marriage-anniversary')->dailyAt('6:00')->timezone($timezone);
        $schedule->command('send-leave-reminder')->dailyAt('10:00')->timezone($timezone);
