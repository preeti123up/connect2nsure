...
class NewLeaveRequest extends BaseNotification
{
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        $content = __('email.leaves.subject') . ' From: ' . $this->leave->user->name . '.' . '<br>' . __('app.date') . ': ' . $this->leave->leave_date->format($this->company->date_format) . '<br>' . __('modules.leaves.leaveType') . ': ' . $this->leave->type->type_name . '<br>' . __('modules.leaves.reason') . ':- ' . $this->leave->reason;
