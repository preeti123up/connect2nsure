...
use App\Listeners\BirthdayWishesListener;
use App\Listeners\WorkAnniversaryListener;
...
use App\Listeners\MarriageAnniversaryListener;
use App\Listeners\LeaveReminderListener;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        BirthdayWishesEvent::class => [BirthdayWishesListener::class],
        WorkAnniversaryEvent::class => [WorkAnniversaryListener::class],
        ...
        MarriageAnniversaryEvent::class => [MarriageAnniversaryListener::class],
        LeaveReminderEvent::class => [LeaveReminderListener::class],
    ];
