...
class EmployeesDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $datatables->editColumn(
         ...
         $datatables->addColumn(
            ...
            function ($row) {
                ...
                if ($row->email_send == 1 ) {
                    return '<span style="margin-left:30px">'.'Yes'.'</span>';
                }
                return '<span style="margin-left:30px">'.'NO'.'</span>';
        ...
        $datatables->rawColumns(array_merge(['name', 'action', 'role', 'email_status','status', 'check', 'employee_id'], $customFieldColumns));
    ...
    public function query(User $model)
    {
        ...
        if ($request->branch != 'all' && $request->branch != '') {
            ...
            $users = $users->whereIn('employee_details.user_id', $assign);
        ...
        if ($this->viewEmployeePermission == 'added') {
            ...
            ->orWhere('employee_details.reporting_to', user()->id);
        }
    ...
    protected function getColumns()
    {
        ...
        $data = [
            ...
            __('Mobile') => ['data' => 'mobile', 'name' => 'mobile', 'title' => __('Mobile')],
            ...
            __('Email Status') => ['data' => 'email_status', 'name' => 'email_send', 'title' => __('Email Sent')],
