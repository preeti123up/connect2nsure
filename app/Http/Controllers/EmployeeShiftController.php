...
class EmployeeShiftController extends AccountBaseController
{
    ...
    public function store(StoreEmployeeShift $request)
    {
        ...
        $setting->office_open_days = $request->office_open_days;
        $setting->early_clock_in = $request->early_clock_in;
        $setting->allow_outside_clockin = $request->allow_outside_clockin ? 1 : 0;
        $setting->save();
    ...
    public function edit($id)
    {
        ...
        $this->openDays = $this->employeeShift->office_open_days;
