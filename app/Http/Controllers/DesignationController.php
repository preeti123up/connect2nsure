...
class DesignationController extends AccountBaseController
{
    ...
    public function child($child)
    {
       ...
       // export designation formate download code

    public function exportFormate(){
            return Excel::download(new DesignationSheetExport(),'designation-formate.xlsx');
    }
    ...
    public function importMember()
    {
        ...
        $this->pageTitle = __('app.importExcel') . ' ' . __('Designation');

        if (request()->ajax()) {
            $html = view('designation.ajax.import', $this->data)->render();

            return Reply::dataOnly(['status' => 'success', 'html' => $html, 'title' => $this->pageTitle]);
        }

        $this->view = 'designation.ajax.import';

        return view('designation.create', $this->data);
    }

    // excel import store code

    public function importStore(ImportRequest $request)
    {

       $this->importFileProcess($request, DesignationImport::class);


       $view = view('designation.ajax.import_progress', $this->data)->render();
    ...
    // excel import process start

    public function importProcess(ImportProcessRequest $request)
    {

        $batch = $this->importJobProcess($request, DesignationImport::class, ImportDesignationJob::class);
