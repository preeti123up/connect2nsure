...
class DepartmentController extends AccountBaseController
{
    ...
    public function getMembers($id)
    {
        ...
        return Excel::download(new DepartmentSheetExport(), 'department-format.xlsx');
    }

    public function importMember()
    {

        $this->pageTitle = __('app.importExcel') . ' ' . __('Department');

        if (request()->ajax()) {
            $html = view('departments.ajax.import', $this->data)->render();

            return Reply::dataOnly(['status' => 'success', 'html' => $html, 'title' => $this->pageTitle]);
        }

        $this->view = 'departments.ajax.import';
    ...
    public function importStore(ImportRequest $request)
    {
        ...
        $this->importFileProcess($request, DepartmentImport::class);


        $view = view('departments.ajax.import_progress', $this->data)->render();
    ...
    public function importProcess(ImportProcessRequest $request)
    {
        ...
        $batch = $this->importJobProcess($request, DepartmentImport::class, ImportDepartmentJob::class);
