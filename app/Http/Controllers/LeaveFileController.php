...
class LeaveFileController extends AccountBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            foreach ($request->file as $fileData) {
                ...
                $filename = Files::uploadLocalOrS3($fileData, LeaveFile::FILE_PATH);
    ...
    public function destroy($id)
    {
        ...
        Files::deleteFile($file->hashname, LeaveFile::FILE_PATH.'/'.$file->filename);
    ...
    public function download($id)
    {
        ...
        return download_local_s3($file, LeaveFile::FILE_PATH.'/'.$file->filename);
