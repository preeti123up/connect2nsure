...
class FeatureSettingController extends AccountBaseController
{
    ...
    public function store(StoreRequest $request)
    {
        ...
        $feature->save();
            ...
            $featureImage->featureImageId=$feature->id;

            if ($request->hasFile('feature_icon1')) {
                $featureImage->	feature_icon1 = Files::uploadLocalOrS3($request->feature_icon1, 'front/feature');
            }
            if ($request->hasFile('feature_icon2')) {
                $featureImage->	feature_icon2 = Files::uploadLocalOrS3($request->feature_icon2, 'front/feature');
            }
            $featureImage->feature_description1=$request->feature_description1;
            $featureImage->feature_description2=$request->feature_description2;
            $featureImage->feature_title1=$request->feature_title1;
            $featureImage->feature_title2=$request->feature_title2;
            $featureImage->save();
    ...
    public function edit(Request $request, $id)
    {
        if($request->type == 'settings'){
            ...
            $this->featureImage = FeatureImage::where('featureImageId',$id)->first();
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        if($feature->type=='image'){
            ...
            $featureImage=FeatureImage::where('featureImageId',$id)->first();
         if($featureImage!=null){

             if ($request->hasFile('feature_icon1')) {
                $featureImage->	feature_icon1 = Files::uploadLocalOrS3($request->feature_icon1, 'front/feature');
            }else{
              $featureImage->	feature_icon1 = null;

            }
            if ($request->hasFile('feature_icon2')) {
                $featureImage->	feature_icon2 = Files::uploadLocalOrS3($request->feature_icon2, 'front/feature');
            }else{
                $featureImage->	feature_icon2 =null;

            }
            $featureImage->feature_description1=$request->feature_description1??null;
            $featureImage->feature_description2=$request->feature_description2??null;
            $featureImage->feature_title1=$request->feature_title1??null;
            $featureImage->feature_title2=$request->feature_title2??null;
            $featureImage->save();
        }else{            
    ...
    public function destroy(Request $request, $id)
    {
        if($request->type == 'settings'){
            ...
            Feature::destroy($id);
           FeatureImage::where('featureImageId',$id)->delete();
